...
<body id="page-top">
                            ...
                            <div class="container-fluid">
                                ...
                                <?php 
                                    ...
                                    switch($source){
                                        ...
                                        case 'add_floor':
                                        include_once("includes/floor/add-floor.php");
                                        break;

                                        case 'edit_floor':
                                        include_once("includes/floor/edit-floor.php");
                                        break;

                                        default: 
                                        include_once("includes/floor/view-floor.php");
                                        break;
                                    }
        ...
        ! function (t) {
            ...
            n.prototype.init = function () {
                t(".delete-floor").click(function (e) {
                    var fid = $(this).attr('data-floor-id');
                     e.preventDefault(); //cancel default action
                     swal({
                         title: "Are you sure, you wanna delete this Floor entry?",
...
//                                        confirmButtonClass: "btn btn-confirm mt-2"
                                        ...
                                        self.location = "floor.php"
                                    })
                                })
                            } else {
                                swal({
                                     title: "Issue !",
                                     text: "There was issue deleteing floor, please try again later!",
                                     icon: "error",
                                     confirmButtonClass: "btn btn-confirm mt-2"
                                })
                            }                
