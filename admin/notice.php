                            ...
                            <div class="container-fluid">
                                ...
                                <?php 
                                    ...
                                    switch($source){
                                        ...
                                        case 'add_notice':
                                        include_once("includes/notice/add-notice.php");
                                        break;

                                        case 'edit_notice':
                                        include_once("includes/notice/edit-notice.php");
                                        break;

                                        default: 
                                        include_once("includes/notice/view-notice.php");
                                        break;
                                    }
       ...
       <script>     
        ! function (t) {
            ...
            n.prototype.init = function () {
                t(".delete-notice").click(function (e) {
                    var nid = $(this).attr('data-notice-id');
                     e.preventDefault(); //cancel default action
                     swal({
                         title: "Are you sure, you wanna delete this notice entry?",
...
//                                        confirmButtonClass: "btn btn-confirm mt-2"
                                        ...
                                        self.location = "notice.php"
                                    })
                                })
                            } else {
                                swal({
                                     title: "Issue !",
                                     text: "There was issue deleteing notice, please try again later!",
                                     icon: "error",
                                     confirmButtonClass: "btn btn-confirm mt-2"
                                })
                            }                
